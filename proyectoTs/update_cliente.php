...
if (isset($_POST['actualizar'])) {
    ...
    $query = "UPDATE cliente SET nombre = '$nombre', direccion = '$direccion', num_telefono = '$num_telefono', correo_electronico = '$correo' WHERE ID_Cliente = $ID_Cliente";
    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="card card-body">
                <form action="update_cliente.php?ID_Cliente=<?php echo $_GET['ID_Cliente']; ?>" method="POST">
